package net.pranjal.testblogmcp.service;

import net.pranjal.testblogmcp.domain.Post;
import net.pranjal.testblogmcp.domain.Writer;
import net.pranjal.testblogmcp.repository.PostRepository;
import net.pranjal.testblogmcp.repository.WriterRepository;
